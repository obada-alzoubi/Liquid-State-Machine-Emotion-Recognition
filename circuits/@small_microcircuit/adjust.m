...
%ADJUST   adjusts small microcircuit parameters.
%   R = ADJUST(C,S1,S2,...,FN1,FP1,FN2,FP2,...) finds the synaptic 
%   parameters A, U, D and F of the small microcircuit C that minimize the
...
%   simulated annealing. The optimized small microcircuit is returned in R.
%
...
%
%         help small_microcircuit/private/asamin
%
...
%
%
%   See also SMALL_MICROCIRCUIT/GENERATE, SMALL_MICROCIRCUIT/VISUALIZE,
%	     SMALL_MICROCIRCUIT/SMALL_MICROCIRCUIT, SMALL_MICROCIRCUIT/PLOT
%
%   Author: Stefan Haeusler, 11/2002, haeusler@igi.tu-graz.ac.at
...
if length(C) ~= 1
   errstr = error(' Function ''adjust'' only defined for a single small circuit.');
end
