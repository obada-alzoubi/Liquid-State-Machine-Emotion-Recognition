...
%GEN_CIRC_TEMP is a tool that helps to generate a pool circuit template.
%   CT = GEN_CIRC_TEMP(NAME,N,S,PAR) generates a pool circuit template CT. The
%   input arguments are
% 
%  	 NAME ... name of the pool circuit template, e.g. 'C1'
