/*
introduces a gradient in synapse density accros the i_index of the network
using the fanin_conn procedure; densitiy increase with index i to become
double as high at the maxs of i
